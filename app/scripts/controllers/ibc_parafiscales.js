...
/**
 * @ngdoc function
 * @name ssClienteApp.controller:IbcParafiscalesCtrl
 * @description
 * # IbcParafiscalesCtrl
 * Controller of the ssClienteApp
 */
angular.module('ssClienteApp')
  .controller('IbcParafiscalesCtrl', function ($scope, seguridadSocialService) {
    var self = this;
    self.conceptos = [];
    
    seguridadSocialService.get('pago/conceptos_ibc_parafiscales', '').then(function (response) {
  ...
  self.guardar = function () {
    seguridadSocialService.post('conceptos_ibc/ActualizarConceptos/parafiscales', self.conceptosActivos).then(function (response) {
